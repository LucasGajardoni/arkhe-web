...
export const FACE_CLIENT_ID = env.VITE_FACE_CLIENT_ID || 'arkhe'
export const FACE_CLIENT_SECRET = env.VITE_FACE_CLIENT_SECRET || 'mariahsaudadespontinaindaamamuitoela' 