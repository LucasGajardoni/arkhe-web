...
import { cpfValido, maiorDeIdade } from '../../utils/validadores.js'

export default function EtapaDados({ empresarial, dadosPF, dadosPJ, alterar }) {
  if (!empresarial) return (
    <div className="grade-formulario">
      <Campo nome="nome" rotulo="Nome completo" valor={dadosPF.nome} alterar={alterar} autocomplete="name" />
...
export function EtapaResponsavel({ dados, alterar }) {
  return (
    <div className="grade-formulario">
      <Campo nome="nomeResponsavel" rotulo="Nome completo" valor={dados.nomeResponsavel} alterar={alterar} autocomplete="name" />
