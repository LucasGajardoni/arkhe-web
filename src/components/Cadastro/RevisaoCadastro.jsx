...
export default function RevisaoCadastro({ empresarial, dadosPF, dadosPJ, dadosAtuais, editarEtapa }) {
  return <div className="revisao-cadastro">
    {empresarial && <BlocoRevisao titulo="Dados da empresa" itens={[["CNPJ", mascaraCnpjParcial(dadosPJ.cnpj)], ['Razão social', dadosPJ.razaoSocial], ['Nome fantasia', dadosPJ.nomeFantasia]]} editar={() => editarEtapa(0)} />}
    <BlocoRevisao titulo={empresarial ? 'Responsável' : 'Dados pessoais'} itens={empresarial ? [['Nome', dadosPJ.nomeResponsavel], ['CPF', mascaraCpfParcial(dadosPJ.cpfResponsavel)], ['Nascimento', formatarDataBrasileira(dadosPJ.dataNascimentoResponsavel)]] : [['Nome', dadosPF.nome], ['CPF', mascaraCpfParcial(dadosPF.cpf)], ['Nascimento', formatarDataBrasileira(dadosPF.dataNascimento)]]} editar={() => editarEtapa(empresarial ? 1 : 0)} />
